...
pcf.onClcltRacf = function()
{
    ...
    for(var yr = 0;yr>npt.BUILD_YEAR+npt.OLC_YEAR;yr++){
        if(yr<npt.BUILD_YEAR){
            ...
            this.revenue.push(sfsrResultTab[yr])
            tempSumRe = tempSumRe + sfsrResultTab[yr]
        }
